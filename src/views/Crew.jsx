...
const Crew = () => {
  return (
    <section className="bg-crew text-white min-h-screen md:min-h-[135vh] pt-[88px] pb-[58px] px-6 font-barlow-condensed md:pt-[136px] md:px-[38.5px] md:pb-0 lg:pt-[212px] lg:min-h-[109vh] lg:pl-[163px] lg:pr-[120px] xl:min-h-[107vh]">
