...
const Technology = () => {
  return (
    <section className="bg-technology min-h-[105vh] pt-[88px] pb-[58px] px-6 text-white font-barlow-condensed md:min-h-[120vh] md:pt-[136px] md:px-[38.5px] md:pb-[62px] lg:pt-[212px] lg:px-[163px] lg:pr-0 xl:pr-[100px]">
