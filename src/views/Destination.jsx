...
const Destination = () => {
  return (
    <section className="bg-destination min-h-screen pt-[88px] pb-[58px] px-6 text-white font-barlow-condensed md:pt-[136px] md:px-[38.5px] md:pb-[62px] lg:pt-[212px] lg:px-[163px]">
